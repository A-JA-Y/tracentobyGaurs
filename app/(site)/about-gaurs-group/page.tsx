...
export const metadata: Metadata = {
  title: "About Gaurs Group | Gaur Builder & Real Estate Developers NCR",
  description:
    "About the Gaursons Group, the Gaur builder behind Trecento Residences: 65+ delivered projects, 65,000+ units and landmark townships in Delhi NCR.",
  alternates: { canonical: `${SITE_URL}/about-gaurs-group` },
  keywords:
    "gaur builder, gaur developers, gaur real estate, gaur projects in delhi ncr, gaur official website, gaur group corporate office, gaur upcoming projects, Gaurs Group, Gaursons Group, Gaur City, Gaur Yamuna City, The Islands by Gaurs, Trecento Residences developer",
};

const credentials = [
  "Active since 1995 — nearly three decades of unbroken delivery across Gaur projects in Delhi NCR",
  ...
  return (
    <>
      ...
      <section className="w-full bg-white py-16 px-6">
        <h1 className="max-w-5xl mx-auto text-3xl md:text-4xl font-semibold text-gray-900 mb-10 border-b border-[#e5dcc5] pb-4">
          &lsquo;The Life Artists&rsquo; — Building Across Delhi NCR Since 1995
        </h1>
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-10 items-start">
          ...
          <div className="flex-1 flex flex-col gap-4">
            <p className="text-gray-600 text-sm leading-relaxed">
              ...
              worked the full width of the market in Gaur real estate, from affordable housing
              through to ultra-luxury apartments, villas and penthouses, making it one of the most
              recognised names among Gaur developers in the region.
            </p>
            <p className="text-gray-600 text-sm leading-relaxed">
              ...
              Gaur builder with 65+ delivered projects and 65,000+ delivered units behind it is the
      ...
      <section className="w-full bg-[#FAF8F4] py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-600 text-sm mb-8 max-w-3xl">
            ...
            developer&rsquo;s own claims — worth verifying against RERA filings and the Gaur
            official website for any specific project you are considering.
          </p>
      ...
      <section className="w-full bg-white py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-600 text-sm mb-8 max-w-3xl">
            ...
            Greater Noida and Ghaziabad — the backdrop against which its Gaur upcoming projects
            are judged.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {landmarkDevelopments.map((dev) => (
              <div
                key={dev.name}
                className="bg-[#FAF8F4] border border-[#e5dcc5] rounded-lg px-5 py-6 text-center"
              >
                <h3 className="text-gray-900 font-semibold text-sm">{dev.name}</h3>
                <p className="mt-2 text-gray-600 text-xs leading-relaxed">{dev.note}</p>
              </div>
            ))}
          </div>

          <div className="mt-10 bg-[#FAF8F4] p-6 rounded-lg border border-[#e5dcc5] text-sm text-gray-600 space-y-2">
            <h3 className="text-base font-semibold text-gray-900 mb-1">Developer Details</h3>
            <p>
